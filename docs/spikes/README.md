...
| [S4 Registry](S4-registry.md) | Matrix frozen | `ExecutableRegistryV1` entry-core、joint assemblyId、Web/Server 生成、10 组 pre-factory mismatch 与双目录/双顺序 runner 已有本地证据 | 补齐 Service/Event bindings、guarded entry-module probe 与 Linux/macOS/Windows 完整矩阵 |

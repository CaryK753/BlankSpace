...
更新时间：2026-09-08。机器可读状态以 [`../status/project-status.json`](../status/project-status.json) 为准。
...
| [S7 Database](S7-database.md) | Matrix frozen | PostgreSQL 18.6 exact digest、`pg`/Kysely/Drizzle/direct SQL、两 owner schema/seed、14 场景与供应链边界已冻结；无执行证据 | 安装 exact spike dependencies，对账 lock，并实现本地 digest-pinned runner |

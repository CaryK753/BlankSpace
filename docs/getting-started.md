...
当前仓库可用于评审架构、RFC、JSON Schema 和 spikes。S1 已验证 JSONC 子集、canonicalization、跨目录 hash、schema corpus、当前环境的 TypeScript typecheck 与 Ajv schema 编译，但仍需在 Node.js 24 下重跑并取得 Vitest evidence。S2 目前只冻结了解析矩阵。

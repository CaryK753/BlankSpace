...
S2～S8 已完成；S1 的生产 JSONC/Schema 校验边界已在本地通过，当前 `A1-S1-02` 正在补齐 Linux、macOS、Windows canonical conformance。S1 正式通过前不得进入 Phase 1B。S8 已在 Ubuntu 24.04 x64 通过 45 个行为检查、144 个 axe scan 与 20 个 Linux Chromium visual comparison，matrix hash 为 `be6a41b0fe50af9c9c1404bea20157d4c286977ec066b4e2dd63279d087d570c`。

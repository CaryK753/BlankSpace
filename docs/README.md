...
当前 S1 为 Provisional pass，S2～S6 为 Pass，S7 为 Provisional pass。S4 已在 Linux、macOS、Windows 上验证 `ExecutableRegistryV1`、joint assemblyId、resolved Service/Event bindings、18 组 pre-factory mismatch 与 guarded generated-entry probe；S5 lifecycle/Event corpus 与 S6 exact Fastify 5.12.3 十场景真实 loopback/deadline/termination corpus 也已完成三平台 canonical 对账，Ubuntu/macOS 的真实 signal 和 Windows 明确平台分支均通过。S7 已在 macOS arm64 上用 PostgreSQL 18.6 exact digest 和 exact `pg`/Kysely/Drizzle 运行 14 场景正反序 migration corpus，canonical hash 为 `8e48920e5c1adc8b9cf327ffeeb195dcc48d2c4c8290a7f0822cbf751313df04`；Ubuntu 尚待验证。当前唯一 ready 工作项是 `A1-S7-03`。链接表示实验规格入口，只有对应状态和 transcript/evidence 明确记录的部分才算已经执行。
